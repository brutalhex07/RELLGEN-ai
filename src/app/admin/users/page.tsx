...
const mockUsers = [
  { id: 1, name: "John Doe", email: "john@example.com", plan: "Pro", credits: 24500, status: "Active", joined: "2024-01-12" },
  { id: 2, name: "Jane Smith", email: "jane@other.com", plan: "Starter", credits: 450, status: "Active", joined: "2024-02-05" },
  { id: 3, name: "Mike Ross", email: "mike@ross.co", plan: "Enterprise", credits: 99999, status: "Blocked", joined: "2023-11-20" },
  { id: 4, name: "Sarah Connor", email: "sarah@future.net", plan: "Pro", credits: 12000, status: "Active", joined: "2024-03-01" },
  { id: 5, name: "Arthur Dent", email: "42@galaxy.com", plan: "Starter", credits: 800, status: "Active", joined: "2024-03-15" },
];
          ...
          <TableBody>
            {mockUsers.map((user) => (
              <TableRow key={user.id} className="border-white/5 hover:bg-white/5 transition-colors group">
                ...
                <TableCell>
                  <div className="flex flex-col">
                    <span className="text-sm font-mono font-bold tracking-tight">{user.credits.toLocaleString()}</span>
