...
import { Zap, Mail, Lock, User, Github, Chrome } from "lucide-react";
        ...
        <CardContent className="space-y-4 pt-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input placeholder="John Doe" className="pl-10 bg-white/5 border-white/10" />
            </div>
          </div>
          <div className="space-y-2">
          ...
          <Link href="/dashboard">
            <Button className="w-full bg-primary hover:bg-primary/90 mt-4 h-11 text-base">Start Creating Free</Button>
          </Link>
